...
namespace agora_gaming_rtc
{
    ...
    internal static class AgoraRtcNative
    {
        ...
        internal static extern IrisRtcEnginePtr CreateIrisRtcEngine(string executable_path);
        ...
        internal static extern int CallIrisRtcRawDataPluginManagerApi(IrisRtcRawDataPluginManagerPtr plugin_manager_ptr,
            ApiTypeRawDataPlugin api_type, byte[] @params, out CharArrayAssistant result);
